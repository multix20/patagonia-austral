...
const DICCIONARIO = {
  es: {
    ...
    reportesNota: 'Los reportes son temporales: se validan o caducan solos con el tiempo.',
    ...
    reporteSinUbicacion: 'Necesitamos tu ubicación (o entra a una localidad) para ubicar el reporte.',
    reporteFaltaTexto: 'Escribe tu comentario antes de enviarlo.',
    ...
    repAlojamiento: 'Alojamiento lleno',
  ...
  en: {
    ...
    reportesNota: 'Reports are temporary: they get confirmed or expire on their own.',
    ...
    reporteSinUbicacion: 'We need your location (or open a locality) to place the report.',
    reporteFaltaTexto: 'Write your comment before sending it.',
    ...
    repFerry: 'Ferry',
    repAlojamiento: 'No rooms available',
